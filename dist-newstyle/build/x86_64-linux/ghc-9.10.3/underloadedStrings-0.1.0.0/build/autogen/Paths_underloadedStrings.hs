...
{-|
Module      : Paths_underloadedStrings
...
-- at runtime using the environment variable underloadedStrings_bindir.
...
-- environment variable underloadedStrings_libdir.
...
-- using the environment variable underloadedStrings_dynlibdir.
...
-- runtime using the environment variable underloadedStrings_datadir.
...
-- variable underloadedStrings_libexedir.
...
-- using the environment variable underloadedStrings_sysconfdir.
...
libdir     = "/home/nick/.cabal/lib/x86_64-linux-ghc-9.10.3-126f/underloadedStrings-0.1.0.0-inplace"
dynlibdir  = "/home/nick/.cabal/lib/x86_64-linux-ghc-9.10.3-126f"
datadir    = "/home/nick/.cabal/share/x86_64-linux-ghc-9.10.3-126f/underloadedStrings-0.1.0.0"
libexecdir = "/home/nick/.cabal/libexec/x86_64-linux-ghc-9.10.3-126f/underloadedStrings-0.1.0.0"
sysconfdir = "/home/nick/.cabal/etc"

getBinDir     = catchIO (getEnv "underloadedStrings_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "underloadedStrings_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "underloadedStrings_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "underloadedStrings_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "underloadedStrings_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "underloadedStrings_sysconfdir") (\_ -> return sysconfdir)
