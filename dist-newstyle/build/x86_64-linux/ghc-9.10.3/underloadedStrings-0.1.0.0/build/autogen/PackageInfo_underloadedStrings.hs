...
{-|
Module      : PackageInfo_underloadedStrings
...
synopsis :: String
synopsis = "Useful functions if you are not using the OverloadedStrings Pragma"
...
homepage :: String
homepage = "https://github.com/cookEbox/underloadedStrings"
